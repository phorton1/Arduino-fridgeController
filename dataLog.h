...
//
// The object keeps track of the minimum and maximum value of each
// column using floats and returns them as part of the chart_header.
//
// Normalization and magic tricks to get jqPlot to work how I want
